        ...
        success:function(data){
            ...
            authorSVG.append("rect")
                    ...
                    .on("mouseover",function(d,i){
                        console.log(d)
                        var bioholder=d3.selectAll(".myslide05")  
                            .append("div")
            ...
            authorSVG.selectAll(".authorInterests")
                    ...
                    .attr("x",screenwidth*0.13+220)
                    .attr("y",function(d,i){
                        return screenheight*0.07+148+i*23
                    })
                    .attr("text-anchor","start")
                    .attr("font-size","15")
                    .attr("fill","white") 
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        if(data.data[0].items){
                                            ...
                                            // console.log(papers)
                                            var authorpaperholder=d3.selectAll(".myslide05")  
                                            .append("div")
